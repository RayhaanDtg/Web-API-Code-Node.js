...
exports.api_songs = function(request, response) {
  ...
  let sql = "SELECT id, title FROM songs WHERE title LIKE ? OR composer LIKE ? ORDER BY title ASC LIMIT 30"
...
exports.api_books = function(request, response) {
  ...
  let sql = "SELECT bookcode, title FROM bookcodes WHERE bookcode LIKE ? OR title LIKE ? ORDER BY bookcode ASC"
  let title = '%' //sql match anything character
